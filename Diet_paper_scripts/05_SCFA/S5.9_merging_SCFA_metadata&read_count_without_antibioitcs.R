...
# read in data ====
baku <- readRDS("Output/Files/S1.6_cleaned_phyloseq_object_MS_without_antibiotics.rds")
...
# save results ====
#write.table (scfa_meta_tp, "S5.9_long_scfa_diet_paper_without_antibiotics.txt", row.names=FALSE,sep = "\t")
