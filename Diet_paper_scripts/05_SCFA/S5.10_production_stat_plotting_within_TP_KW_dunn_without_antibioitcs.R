...
# read in data ====
scfa <- read.delim("Output/Files/S5.9_long_scfa_diet_paper_without_antibiotics.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
ggsave(
  filename   = "S5.10_scfa_production_without_antibiotics.svg",
  plot       = combined_plot,
