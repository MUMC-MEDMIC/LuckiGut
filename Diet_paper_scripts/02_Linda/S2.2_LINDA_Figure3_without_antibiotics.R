...
ps_diet <- readRDS("Output/Files/S1.6_cleaned_phyloseq_object_MS_without_antibiotics.rds")
...
#write.table (all, "S2.2_LINDA_results_all_without_antibiotics.txt", row.names=FALSE,sep = "\t")
...
ggsave(
  filename   = "S2.2_linda_heatmap_without_antibiotics.tiff",
  plot       = panel_3A_with,
