...
tiff("S4.3_DMM_heatmap.tiff",width = 500, height = 300, units = "mm", res = 300, compression = "lzw")
draw(plot2)
dev.off()
pdf("S4.3_DMM_heatmap.pdf", width = 12, height = 8)  # inches
draw(plot2)
dev.off()
