...
plot <- infant_merged %>% 
  ...
  ord_calc(method = "PCA") %>% 
  ord_plot(color = "DMM_Cluster_recoded",auto_caption = NA)+scale_color_viridis(discrete = TRUE)+
...
ggsave("S4.4_DMM_PCA.tiff", plot, width = 500, height = 300, dpi = 300, units = "mm")
