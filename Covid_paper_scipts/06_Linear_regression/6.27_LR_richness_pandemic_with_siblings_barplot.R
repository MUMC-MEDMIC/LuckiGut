...
# Import data ====
model <- read.delim("Output/Files/S6.26_LR_pandemic_rich_scaled_with_siblings_cleaned.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
ggsave(
  filename   = "S6.27_LR_richness_scaled_with_siblings.tiff",
  plot       = plot,
