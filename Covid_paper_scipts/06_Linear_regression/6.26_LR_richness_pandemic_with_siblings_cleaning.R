...
# Import data ====
model <- read.delim("Output/Files/S6.25_LR_pandemic_rich_scaled_raw_with_siblings.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
# saving data ====
#write.table (model, "S6.26_LR_pandemic_rich_scaled_with_siblings_cleaned.txt", row.names=FALSE,sep = "\t")
