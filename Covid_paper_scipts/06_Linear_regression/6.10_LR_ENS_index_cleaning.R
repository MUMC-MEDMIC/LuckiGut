...
# Import data ====
model <- read.delim("Output/Files/S6.9_LR_ENS_index_scaled_raw.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
# saving data ====
#write.table (model, "S6.10_LR_index_ENS_scaled_cleaned.txt", row.names=FALSE,sep = "\t")
