...
# Import data ====
model <- read.delim("Output/Files/S6.17_LR_pandemic_ENS_scaled_raw_without_outliers.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
# saving data ====
#write.table (model, "S6.18_LR_pandemic_ENS_scaled_cleaned_without_outliers.txt", row.names=FALSE,sep = "\t")
