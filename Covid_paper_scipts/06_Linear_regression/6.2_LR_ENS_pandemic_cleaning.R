...
# Import data ====
model <- read.delim("Output/Files/S6.1_LR_pandemic_ENS_scaled_raw.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
# saving data ====
#write.table (model, "S6.2_LR_pandemic_ENS_scaled_cleaned.txt", row.names=FALSE,sep = "\t")
