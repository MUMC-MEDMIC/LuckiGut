...
# Import data ====
model <- read.delim("Output/Files/S6.5_LR_pandemic_rich_scaled_raw.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
# saving data ====
#write.table (model, "S6.6_LR_pandemic_rich_scaled_cleaned.txt", row.names=FALSE,sep = "\t")
