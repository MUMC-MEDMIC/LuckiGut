...
# saving data ====
#write.table (all, "S6.5_LR_pandemic_rich_scaled_raw.txt", row.names=FALSE,sep = "\t")
...
# saving data ====
#write.table (final_diagnostics, "S6.5_LR_pandemic_rich_scaled_residuals_raw.txt", row.names=TRUE,sep = "\t")
