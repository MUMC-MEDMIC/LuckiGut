...
# Import data ====
model <- read.delim("Output/Files/S6.2_LR_pandemic_ENS_scaled_cleaned.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
#ggsave("S6.31_LR_pandemic_ENS_scaled.pdf", plot, device = "pdf",width = 400, height = 300, dpi = 300, units = "mm")

ggsave(
  filename   = "S6.3_LR_pandemic_ENS_scaled.tiff",
  plot       = plot,
