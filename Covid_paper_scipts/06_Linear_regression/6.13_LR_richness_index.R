...
# saving data ====
#write.table (all, "S6.13_LR_rich_index_scaled_raw.txt", row.names=FALSE,sep = "\t")
...
# saving data ====
#write.table (final_diagnostics, "S6.13_LR_rich_index_scaled_residuals_raw.txt", row.names=FALSE,sep = "\t")
