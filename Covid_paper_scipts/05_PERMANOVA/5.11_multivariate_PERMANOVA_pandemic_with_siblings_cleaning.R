...
# Import data ====
model <- read.delim("Output/Files/S5.10_PERMANOVA_results_with_siblings_raw.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
# saving data ====
#write.table (model, "S5.11_PERMANOVA_results_cleaned_with_siblings.txt", row.names=FALSE,sep = "\t")
