...
# Import data ====
model <- read.delim("Output/Files/S5.14_PERMANOVA_results_cleaned_without_siblings.txt",sep = "\t",header = TRUE, na.strings=c("","NA"))
...
ggsave(
  filename   = "S5.15_PERMANOVA_final_without_siblings.tiff",
  plot       = plot,
